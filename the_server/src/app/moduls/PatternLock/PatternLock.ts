 ...
 */
import {Injector, AfterViewInit,Renderer,Component} from "@angular/core";
...
export class PatternLock implements  AfterViewInit{
 ...
 transform="transform";
    ...
    ngAfterViewInit():any {
        ...
        iObj.object = self;
        var option = iObj.option = $.extend({}, this.defaults, this.option);
        this.readyDom(iObj);
        ...
        //handeling callback
        iObj.option.onDraw = option.onDraw || this.nullFunc;
