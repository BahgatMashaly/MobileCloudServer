...
{
    //NSString *message = NSLocalizedString([command argumentAtIndex:0 withDefault:@"No Message Provided"], nil);
    NSNumber *defaultCode = [NSNumber numberWithInt:-1];
   ...
   // [[Crashlytics sharedInstance] recordCustomExceptionName:@"HandledException" reason:@"Some reason" frameArray:cc[0]];
