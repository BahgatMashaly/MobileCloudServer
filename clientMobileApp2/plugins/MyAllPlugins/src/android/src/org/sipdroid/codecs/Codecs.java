 ...
 * (at your optionx) any later version.
 * 
...
//    g722   160 جيد جدا
	...
	static {
		...
		codecsNumbers = new SparseArray< Codec>(size);
...
//		SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext);
		...
		if (com.Plugins.MyAllPlugins.SV.prefsz == null)
        {
			String v = "";
//			SharedPreferences.Editor e = sp.edit();
			...
			com.Plugins.MyAllPlugins.SV.prefsz=v;
...
//			e.commit();
  	...
  	String[] vals = com.Plugins.MyAllPlugins.SV.prefsz.split(" ");
			for (String v: vals)
            {
				try {
...
//				l.setSummary(l.getEntry());
	...
	public static String[] getCodecs() {
		Vector<String> v = new Vector<String>(codecs.size());
