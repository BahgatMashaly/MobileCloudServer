package com.Plugins.MyAllPlugins.forHttps;

/**
 * Created by Bahgat on 4/16/16.
 */
...
public class ExSSLSocketFactory extends SSLSocketFactory {
    ...
    public static HttpClient customHttpsClientx(HttpClient client) {
        try{
            ...
            schemeRegistry.register(new Scheme("https", sslSocketFactory, SV.server_port_https));
